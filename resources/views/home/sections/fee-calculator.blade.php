...
<section class="fee-calc-sec">
    <div class="si">
        <div style="text-align:center;margin-bottom:.35rem">
            ...
            <p class="sec-sub" style="margin:0 auto;text-align:center" id="fc-sub">Estimate your annual school fees
                based on type, grade, and number of children.</p>
        </div>
        ...
        <div class="fc-card">
            ...
            <div class="fc-result" id="fc-result" style="display:none">
                ...
                <p class="fc-note" id="fc-note">Fees are estimates based on current data. Contact school for exact fees.
                </p>
            </div>
        </div>
    </div>
...
@push('styles')
    <style>
        ...
        .fc-card {
            ...
            margin-top: 2rem;
            box-shadow: 0 2px 16px rgba(15, 41, 66, .06);
        }
        ...
        .fc-result-total {
            background: #E8F5F2;
            border-color: rgba(20, 143, 119, .25);
        }
