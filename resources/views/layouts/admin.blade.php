...
<head>
    ...
    <style>
        ...
        * {
        ...
        .stat-card.c3::after {
            background: linear-gradient(90deg, var(--warn), #d35400);
        }
        ...
        .fi:focus {
            border-color: var(--teal);
            box-shadow: 0 0 0 3px rgba(20, 143, 119, .08);
        }
